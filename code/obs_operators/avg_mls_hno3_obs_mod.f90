...
#include "CMN_SIZE" ! size parameters
    ...
    REAL*8 ::  NEW_COST(IIPAR,JJPAR,LLPAR)       ! super observation cost function contribution
             ...
             DO L = 1, LLPAR
                ...
                IF( ( GET_PCENTER(I,J,L) < 151 ) .AND. ( GET_PCENTER(I,J,L) > 15 ) ) THEN
                   ...
                   IF (NCP(L)>0) THEN
                      ...
                      COST_CONTRIB = 0.5 * (DIFF/OBS_ERROR)**2
                      IF 
                      IF (SUPER_OBS) THEN
                         NEW_COST(I,J,L) = NEW_COST(I,J,L) + COST_CONTRIB                      
             ...
             IF(SOBS_COUNT(I,J) > 0d0) THEN
                ...
                DO L = 1,LLPAR
                   IF( ( GET_PCENTER(I,J,L) < 151 ) .AND. ( GET_PCENTER(I,J,L) > 15 ) ) THEN
                      ...
                      STT_ADJ(I,J,L,IDTHNO3) = STT_ADJ(I,J,L,IDTHNO3) + SOBS_ADJ_FORCE(I,J,L)/SOBS_COUNT(I,J)
