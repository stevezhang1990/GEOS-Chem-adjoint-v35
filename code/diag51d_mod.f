...
!  Module Variables:
!  ============================================================================
!  (1 ) DO_SAVE_DIAG51d  (LOGICAL ) : Flag to turn on DIAG51 timseries
...
!  Module Procedures:
!  ============================================================================
!  (1 ) DIAG51d                     : Driver subroutine for US grid timeseries
...
!  (7 ) CLEANUP_DIAG51d             : Deallocates all module arrays
!
...
!
      ...
      PUBLIC :: DO_SAVE_DIAG51d

      ! ... and these routines
      PUBLIC :: CLEANUP_DIAG51d
      PUBLIC :: DIAG51d
      PUBLIC :: INIT_DIAG51d
...
#     include "CMN_GCTM"  ! SCALE_HEIGHT
     ...
     &                   IDTN2O5 > 0 .and. IDTHNO4 > 0 )
      ...
      WRITE( 6, 100 ) STAMP
 100  FORMAT( '     - DIAG51d: Accumulation at ', a )
...
#     include "CMN_SIZE"  ! Size Parameters
 ...
 100  FORMAT( '     - DIAG51d: Opening file ', a )
      ...
      STAMP = TIMESTAMP_STRING()
      WRITE( 6, 110 ) STAMP
 110  FORMAT( '     - DIAG51d: Saving to disk at ', a )
...
!$OMP END PARALLEL DO
 ...
 120  FORMAT( '     - DIAG51d: Closing file ', a )
      ...
      STAMP = TIMESTAMP_STRING()
      WRITE( 6, 130 ) STAMP
 130  FORMAT( '     - DIAG51d: Zeroing arrays at ', a )
...
!------------------------------------------------------------------------------
      ...
      SUBROUTINE INIT_DIAG51d( DO_ND51, N_ND51, TRACERS, HR_WRITE,
     &                        HR1,     HR2,    IMIN,    IMAX,
...
#     include "CMN_SIZE"   ! Size parameters
      ...
      ! Initialize
      LOCATION               = 'INIT_DIAG51d ("diag51_mod.f")'
      ND51_TRACERS(:)        = 0

      ! Get values from "input_mod.f"
      DO_SAVE_DIAG51d        = DO_ND51
      ...
      ! Return to calling program
      END SUBROUTINE INIT_DIAG51d

!------------------------------------------------------------------------------

      SUBROUTINE CLEANUP_DIAG51d
!
!******************************************************************************
...
!
      ...
      ! Return to calling program
      END SUBROUTINE CLEANUP_DIAG51d

!------------------------------------------------------------------------------

      ! End of module
      END MODULE DIAG51d_MOD
