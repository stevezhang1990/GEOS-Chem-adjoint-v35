! $Id: diag51_mod.f,v 1.1 2009/06/09 21:51:52 daven Exp $
      MODULE DIAG51c_MOD
!
!******************************************************************************
...
!  Module Variables:
!  ============================================================================
!  (1 ) DO_SAVE_DIAG51c  (LOGICAL ) : Flag to turn on DIAG51 timseries
...
!  Module Procedures:
!  ============================================================================
!  (1 ) DIAG51c                     : Driver subroutine for US grid timeseries
...
!  (7 ) CLEANUP_DIAG51c             : Deallocates all module arrays
!
...
!
      ...
      PUBLIC :: DO_SAVE_DIAG51c

      ! ... and these routines
      PUBLIC :: CLEANUP_DIAG51c
      PUBLIC :: DIAG51c
      PUBLIC :: INIT_DIAG51c
...
#     include "CMN_GCTM"  ! SCALE_HEIGHT
     ...
     &                   IDTN2O5 > 0 .and. IDTHNO4 > 0 )
      ...
      WRITE( 6, 100 ) STAMP
 100  FORMAT( '     - DIAG51c: Accumulation at ', a )
...
#     include "CMN_SIZE"  ! Size Parameters
 ...
 100  FORMAT( '     - DIAG51c: Opening file ', a )
      ...
      STAMP = TIMESTAMP_STRING()
      WRITE( 6, 110 ) STAMP
 110  FORMAT( '     - DIAG51c: Saving to disk at ', a )
...
!$OMP END PARALLEL DO
 ...
 120  FORMAT( '     - DIAG51c: Closing file ', a )
      ...
      STAMP = TIMESTAMP_STRING()
      WRITE( 6, 130 ) STAMP
 130  FORMAT( '     - DIAG51c: Zeroing arrays at ', a )
...
!------------------------------------------------------------------------------
      ...
      SUBROUTINE INIT_DIAG51c( DO_ND51, N_ND51, TRACERS, HR_WRITE,
     &                        HR1,     HR2,    IMIN,    IMAX,
...
#     include "CMN_SIZE"   ! Size parameters
      ...
      ! Initialize
      LOCATION               = 'INIT_DIAG51c ("diag51_mod.f")'
      ND51_TRACERS(:)        = 0

      ! Get values from "input_mod.f"
      DO_SAVE_DIAG51c        = DO_ND51
      ...
      ! Return to calling program
      END SUBROUTINE INIT_DIAG51c

!------------------------------------------------------------------------------

      SUBROUTINE CLEANUP_DIAG51c
!
!******************************************************************************
...
!
      ...
      ! Return to calling program
      END SUBROUTINE CLEANUP_DIAG51c

!------------------------------------------------------------------------------

      ! End of module
      END MODULE DIAG51c_MOD
