...
! Aggregate function
  ...
  Vdot(56) = A(22)-A(23)+A(37)+A(39)+0.1*A(55)+A(56)+A(58)+0.08*A(59)+0.05*A(60)+A(62)+A(64)+0.1*A(65)+0.85*A(68)+A(70)&
               &+A(86)+A(108)+0.425*A(122)+A(144)+A(145)+A(159)+A(185)+0.85*A(205)+A(242)-A(246)+0.5*A(254)+A(255)+2*A(256)&
               &+A(259)-A(267)
