...
!
      ...
      REAL*4,  ALLOCATABLE :: COSF(:,:,:)
      REAL*8,  ALLOCATABLE :: CO_CH4(:,:,:,:)
...
!$OMP+PRIVATE( CO_OH, PCO, YMID, CO_VOC                           )
      ...
      DO I = 1, IIPAR
         ...
         CALL CHECK_VALUE( CO_CH4, ERR_LOC,
     &                  ERR_VAR, ERR_MSG  )
     ...
     &                 ( 12d0           / 28d0         )
            ...
            CALL CHECK_VALUE( CO_ISOP, ERR_LOC,
     &                     ERR_VAR, ERR_MSG  )
            ...
            CALL CHECK_VALUE( CO_CH3OH, ERR_LOC,
     &                     ERR_VAR, ERR_MSG  )
         ENDIF
         ...
         IF ( L == 1 ) THEN
            ...
            CALL CHECK_VALUE( CO_MONO, ERR_LOC,
     &                     ERR_VAR, ERR_MSG  )
         ENDIF
         ...
         IF ( L == 1 ) THEN
            ...
            CALL CHECK_VALUE( CO_ACET, ERR_LOC,
     &                     ERR_VAR, ERR_MSG  )
         ENDIF
         ...
         IF ( ITS_IN_THE_STRAT( I, J, L ) ) THEN
            ...
            CALL CHECK_VALUE( CO_OH, ERR_LOC,
     &                     ERR_VAR, ERR_MSG  )
...
!!  (5 ) VALUE (REAL*8 ) : Value to store in (I,J,N)th element of array
!!  NOTES:
!!******************************************************************************
!
!      ! Arguments
...
!!  (3 ) L     (INTEGER) : Index for 1st dimension of array
!!  (4 ) N     (INTEGER) : Index for time steps
!!  (6 ) VALUE (REAL*8 ) : Value to store in (I,J,N)th element of array
!!
!!  NOTES:
!!*****************************************************************************
!      ! Arguments
